...
namespace EmilioMarket.Controllers
{
    ...
    {
        private EmilioMarketContext db = new EmilioMarketContext();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.DocumentTypeId = new SelectList(db.DocumentTypes.OrderBy(c => c.Description), "DocumentTypeId", "Description", employee.DocumentTypeId);
            return View(employee);
        }
